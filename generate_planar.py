...
def generate():
    ...
    os.mkdir("./outputs_planar/"+out_name)
    ...
    while(not done):
        ...
        done = (terminate.item() > 0.7) or (i>50) or (3+i)>=lf.shape[0];  stat[len(ligand_z)] = terminate.item()
        if(done):
        ...
        try:
            ...
            with SDWriter('./outputs_planar/'+out_name+'/'+str(i)+'.sdf') as w:
                w.write(rdmol)
            ...
            res.save('./outputs_planar/'+out_name+'/_'+str(i)+'.png')
